...
class ConditionalUnet(nn.Module):
    ...
    def forward(self, x, t, c):
        ...
        fusion1 = self.fusion1(self.downblock1(down0),temb2,cemb2)
        fusion2 = self.fusion2(self.downblock2(fusion1),temb1,cemb1)
        up0 = self.upblock0(self.to_vec(fusion2))
        fusion3 = self.fusion3(self.upblock1(fusion2,up0),temb2,cemb2)
        fusion4 = self.fusion4(self.upblock2(fusion1,fusion3),temb2,cemb2)
